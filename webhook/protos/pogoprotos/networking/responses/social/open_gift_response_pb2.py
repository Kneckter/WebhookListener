...
# source: pogoprotos/networking/responses/social/open_gift_response.proto
...
_OPENGIFTRESPONSE_RESULT = _descriptor.EnumDescriptor(
  name='Result',
  full_name='pogoprotos.networking.responses.social.OpenGiftResponse.Result',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_OPENGIFTRESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.responses.social.OpenGiftResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='result', full_name='pogoprotos.networking.responses.social.OpenGiftResponse.result', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='items', full_name='pogoprotos.networking.responses.social.OpenGiftResponse.items', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='egg_pokemon', full_name='pogoprotos.networking.responses.social.OpenGiftResponse.egg_pokemon', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='updated_friendship_data', full_name='pogoprotos.networking.responses.social.OpenGiftResponse.updated_friendship_data', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='friend_profile', full_name='pogoprotos.networking.responses.social.OpenGiftResponse.friend_profile', index=4,
...
OpenGiftResponse = _reflection.GeneratedProtocolMessageType('OpenGiftResponse', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.responses.social.open_gift_response_pb2'
  # @@protoc_insertion_point(class_scope:pogoprotos.networking.responses.social.OpenGiftResponse)
  ))
