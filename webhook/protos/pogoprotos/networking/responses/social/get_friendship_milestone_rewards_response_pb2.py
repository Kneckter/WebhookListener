...
# source: pogoprotos/networking/responses/social/get_friendship_milestone_rewards_response.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/responses/social/get_friendship_milestone_rewards_response.proto',
  package='pogoprotos.networking.responses.social',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\nVpogoprotos/networking/responses/social/get_friendship_milestone_rewards_response.proto\x12&pogoprotos.networking.responses.social\"\xc1\x02\n%GetFriendshipMilestoneRewardsResponse\x12\x64\n\x06result\x18\x01 \x01(\x0e\x32T.pogoprotos.networking.responses.social.GetFriendshipMilestoneRewardsResponse.Result\x12\x11\n\txp_reward\x18\x02 \x01(\x03\x12\x11\n\tfriend_id\x18\x03 \x01(\t\"\x8b\x01\n\x06Result\x12\t\n\x05UNSET\x10\x00\x12\x0b\n\x07SUCCESS\x10\x01\x12\x11\n\rERROR_UNKNOWN\x10\x02\x12\x15\n\x11\x45RROR_NOT_FRIENDS\x10\x03\x12#\n\x1f\x45RROR_MILESTONE_ALREADY_AWARDED\x10\x04\x12\x1a\n\x16\x45RROR_FAILED_TO_UPDATE\x10\x05\x62\x06proto3')
)
...
_GETFRIENDSHIPMILESTONEREWARDSRESPONSE_RESULT = _descriptor.EnumDescriptor(
  name='Result',
  full_name='pogoprotos.networking.responses.social.GetFriendshipMilestoneRewardsResponse.Result',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_GETFRIENDSHIPMILESTONEREWARDSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.responses.social.GetFriendshipMilestoneRewardsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='result', full_name='pogoprotos.networking.responses.social.GetFriendshipMilestoneRewardsResponse.result', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='xp_reward', full_name='pogoprotos.networking.responses.social.GetFriendshipMilestoneRewardsResponse.xp_reward', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='friend_id', full_name='pogoprotos.networking.responses.social.GetFriendshipMilestoneRewardsResponse.friend_id', index=2,
...
GetFriendshipMilestoneRewardsResponse = _reflection.GeneratedProtocolMessageType('GetFriendshipMilestoneRewardsResponse', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.responses.social.get_friendship_milestone_rewards_response_pb2'
  # @@protoc_insertion_point(class_scope:pogoprotos.networking.responses.social.GetFriendshipMilestoneRewardsResponse)
  ))
