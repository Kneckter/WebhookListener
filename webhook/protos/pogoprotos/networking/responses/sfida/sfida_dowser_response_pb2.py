...
# source: pogoprotos/networking/responses/sfida/sfida_dowser_response.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/responses/sfida/sfida_dowser_response.proto',
  package='pogoprotos.networking.responses.sfida',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\nApogoprotos/networking/responses/sfida/sfida_dowser_response.proto\x12%pogoprotos.networking.responses.sfida\"\xf7\x01\n\x13SfidaDowserResponse\x12Q\n\x06result\x18\x01 \x01(\x0e\x32\x41.pogoprotos.networking.responses.sfida.SfidaDowserResponse.Result\x12\x11\n\tproximity\x18\x02 \x01(\x05\x12\x15\n\rspawnpoint_id\x18\x03 \x01(\t\"c\n\x06Result\x12\t\n\x05UNSET\x10\x00\x12\t\n\x05\x46OUND\x10\x01\x12\n\n\x06NEARBY\x10\x02\x12\x10\n\x0cOUT_OF_RANGE\x10\x03\x12\x12\n\x0e\x41LREADY_CAUGHT\x10\x04\x12\x11\n\rNOT_AVAILABLE\x10\x05\x62\x06proto3')
)
...
_SFIDADOWSERRESPONSE_RESULT = _descriptor.EnumDescriptor(
  name='Result',
  full_name='pogoprotos.networking.responses.sfida.SfidaDowserResponse.Result',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_SFIDADOWSERRESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.responses.sfida.SfidaDowserResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='result', full_name='pogoprotos.networking.responses.sfida.SfidaDowserResponse.result', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='proximity', full_name='pogoprotos.networking.responses.sfida.SfidaDowserResponse.proximity', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='spawnpoint_id', full_name='pogoprotos.networking.responses.sfida.SfidaDowserResponse.spawnpoint_id', index=2,
...
SfidaDowserResponse = _reflection.GeneratedProtocolMessageType('SfidaDowserResponse', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.responses.sfida.sfida_dowser_response_pb2'
  # @@protoc_insertion_point(class_scope:pogoprotos.networking.responses.sfida.SfidaDowserResponse)
  ))
