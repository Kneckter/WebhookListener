...
# source: pogoprotos/networking/responses/sfida/sfida_capture_response.proto
...
_SFIDACAPTURERESPONSE_RESULT = _descriptor.EnumDescriptor(
  name='Result',
  full_name='pogoprotos.networking.responses.sfida.SfidaCaptureResponse.Result',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_SFIDACAPTURERESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.responses.sfida.SfidaCaptureResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='result', full_name='pogoprotos.networking.responses.sfida.SfidaCaptureResponse.result', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='xp_gain', full_name='pogoprotos.networking.responses.sfida.SfidaCaptureResponse.xp_gain', index=1,
...
SfidaCaptureResponse = _reflection.GeneratedProtocolMessageType('SfidaCaptureResponse', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.responses.sfida.sfida_capture_response_pb2'
  # @@protoc_insertion_point(class_scope:pogoprotos.networking.responses.sfida.SfidaCaptureResponse)
  ))
