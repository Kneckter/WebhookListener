...
from pogoprotos.enums import store_pb2 as pogoprotos_dot_enums_dot_store__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\nTpogoprotos/networking/requests/messages/download_remote_config_version_message.proto\x12\'pogoprotos.networking.requests.messages\x1a\x1fpogoprotos/enums/platform.proto\x1a\x1cpogoprotos/enums/store.proto\"\xd2\x01\n\"DownloadRemoteConfigVersionMessage\x12,\n\x08platform\x18\x01 \x01(\x0e\x32\x1a.pogoprotos.enums.Platform\x12\x1b\n\x13\x64\x65vice_manufacturer\x18\x02 \x01(\t\x12\x14\n\x0c\x64\x65vice_model\x18\x03 \x01(\t\x12\x0e\n\x06locale\x18\x04 \x01(\t\x12\x13\n\x0b\x61pp_version\x18\x05 \x01(\r\x12&\n\x05store\x18\x06 \x01(\x0e\x32\x17.pogoprotos.enums.Storeb\x06proto3')
  ,
  dependencies=[pogoprotos_dot_enums_dot_platform__pb2.DESCRIPTOR,pogoprotos_dot_enums_dot_store__pb2.DESCRIPTOR,])
...
_DOWNLOADREMOTECONFIGVERSIONMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='store', full_name='pogoprotos.networking.requests.messages.DownloadRemoteConfigVersionMessage.store', index=5,
...
_DOWNLOADREMOTECONFIGVERSIONMESSAGE.fields_by_name['store'].enum_type = pogoprotos_dot_enums_dot_store__pb2._STORE
