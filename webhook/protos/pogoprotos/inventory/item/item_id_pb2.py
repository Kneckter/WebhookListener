...
_ITEMID = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_MOVE_REROLL_FAST_ATTACK', index=45, number=1201,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_MOVE_REROLL_SPECIAL_ATTACK', index=46, number=1202,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_RARE_CANDY', index=47, number=1301,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_FREE_RAID_TICKET', index=48, number=1401,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_PAID_RAID_TICKET', index=49, number=1402,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_LEGENDARY_RAID_TICKET', index=50, number=1403,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_STAR_PIECE', index=51, number=1404,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_FRIEND_GIFT_BOX', index=52, number=1405,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_TEAM_CHANGE', index=53, number=1406,
      options=None,
      type=None),
  ],
