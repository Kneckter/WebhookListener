...
_FORTSETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='enable_sponsored_poi_decorators', full_name='pogoprotos.settings.FortSettings.enable_sponsored_poi_decorators', index=11,
