...
def get_args():
    ...
    parser.add_argument('--log-ghir-enc', help=('Tells the logger to display the encoded GetHoloInventoryResponse in console and write it to the log file.'), action='store_true', default=False)
    parser.add_argument('--log-ghir-par', help=('Tells the logger to display the parsed GetHoloInventoryResponse in console and write it to the log file.'), action='store_true', default=False)
    parser.add_argument('--log-fsr-enc', help=('Tells the logger to display the encoded FortSearchResponse in console and write it to the log file.'), action='store_true', default=False)
    parser.add_argument('--log-fsr-par', help=('Tells the logger to display the parsed FortSearchResponse in console and write it to the log file.'), action='store_true', default=False)
    ...
    parser.add_argument('--trainerlvl', type=int, help=('Used to set the minimal trainer level for EncounterResponse.'), default=30)
    parser.add_argument('--log-cpr-enc', help=('Tells the logger to display the encoded CatchPokemonResponse in console and write it to the log file.'), action='store_true', default=False)
    parser.add_argument('--log-cpr-par', help=('Tells the logger to display the parsed CatchPokemonResponse in console and write it to the log file.'), action='store_true', default=False)
    ...
    parser.add_argument('--log-riir-enc', help=('Tells the logger to display the encoded RecycleInventoryItemResponse in console and write it to the log file.'), action='store_true', default=False)
    parser.add_argument('--log-riir-par', help=('Tells the logger to display the parsed RecycleInventoryItemResponse in console and write it to the log file.'), action='store_true', default=False)
    parser.add_argument('--log-der-enc', help=('Tells the logger to display the encoded DiskEncounterResponse in console and write it to the log file.'), action='store_true', default=False)
    parser.add_argument('--log-der-par', help=('Tells the logger to display the parsed DiskEncounterResponse in console and write it to the log file.'), action='store_true', default=False)
    ...
    parser.add_argument('--log-grdr-enc', help=('Tells the logger to display the encoded GetRaidDetailsResponse in console and write it to the log file.'), action='store_true', default=False)
    parser.add_argument('--log-grdr-par', help=('Tells the logger to display the parsed GetRaidDetailsResponse in console and write it to the log file.'), action='store_true', default=False)
    parser.add_argument('--log-rqr-enc', help=('Tells the logger to display the encoded RemoveQuestResponse in console and write it to the log file.'), action='store_true', default=False)
    parser.add_argument('--log-rqr-par', help=('Tells the logger to display the parsed RemoveQuestResponse in console and write it to the log file.'), action='store_true', default=False)
